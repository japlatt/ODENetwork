...
network_pickle = open('results/network.pickle','rb')
AL = pickle.load(network_pickle)
network_pickle.close()


stimuli_pickle = open('results/stimuli.pickle','rb')
...
np.save('results/AL_3090_od{0}_inj{1}_t{2}'.format(odor,conc,trial),data[pn_inds])
