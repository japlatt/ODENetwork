...
mb_para = dict(num_kc=100, # flies: 2500
    KCClass = nm.HHNeuronWithCaJL, GGNClass = nm.LN,
    KCSynapseClass = nm.Synapse_glu_HH, GGNSynapseClass = nm.Synapse_gaba_LN, gGNNKC=0.5)
...
lm.plot_LFP(time_sampled_range, data, AL, layer_pn = 0)
